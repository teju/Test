...
import com.bikerservice.Utils.Constants;
import com.bikerservice.Utils.CustomToast;
import com.bikerservice.Utils.IsNetworkConnection;
import com.bikerservice.Utils.PrintClass;
import com.bikerservice.Utils.post_async;
import com.bikerservice.model.NotificationModel;
    ...
    public void ResponseOfReadNotification(String resultString, NotificationModel notiList) {
        try {
            ...
            if(notiList.getAction().contains("reached_destination")) {
                Intent i = new Intent(Notifications.this, ReachedDestination.class);
                ...
                Intent i = new Intent(Notifications.this, BookingDetails.class);
                startActivity(i);
            } else  if(notiList.getAction().contains("completed")) {
                Intent i = new Intent(Notifications.this, BookingCompleted.class);
                startActivity(i);
            } else {
